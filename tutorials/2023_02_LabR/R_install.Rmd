...
R is available for Linux, macOS and Windows. Here we describe the steps to install R in each OS. If you experience problems in any step, please check the instructions on [CRAN](https://cran.r-project.org/). If the problems persist, please message me at `fernando [dot] correr [at] montana [dot] edu`.
